...
class DreamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dream" do
    assert_difference("Dream.count") do
      post dreams_url, params: { dream: { description: @dream.description, summary: @dream.summary, user_id: @dream.user_id } }
    end
  ...
  test "should update dream" do
    patch dream_url(@dream), params: { dream: { description: @dream.description, summary: @dream.summary, user_id: @dream.user_id } }
